...
enum class SIM8xxEcho : uint8_t
{
	Off = 0,
	On = 1
};

enum class SIM8xxSmsMessageFormat : uint8_t
{
	Pdu = 0,
	Text = 1
};
 ...
 */
enum class SIM8xxHttpAction : uint8_t
{
	Get = 0,
	Post = 1,
	Head = 2
 ...
 */
enum class SIM8xxHttpActionResponse : uint8_t
{
 ...
 */
enum class SIM8xxRegistrationStatusResponse : uint8_t
{
	N = 0,		///< Controls network registration unsolicited result code.
	Stat = 1,	///< Current registration status. See SIM8xxNetworkRegistrationState.
 ...
 */
enum class SIM8xxSignalQualityResponse : uint8_t
{
	SignalStrength = 0,	///< Received Signal Strength Indication
	BitErrorrate = 1	///< Bit Error Rate
};

enum class SIM8xxPhoneFunctionality : int8_t
{
...
enum class SIM8xxGpsStatus : int8_t
{
...
enum class SIM8xxGpsField : uint8_t
{
...
enum class SIM8xxBatteryChargeField : uint8_t
{
...
enum class SIM8xxSlowClock : uint8_t
{
...
enum class SIM8xxChargingState : int8_t
{
...
enum class SIM8xxNetworkRegistrationState : int8_t
{
...
struct SIM8xxSignalQualityReport
{
...
struct SIM8xxChargingStatus
{
	SIM8xxChargingState state;	///< Current charging state.
